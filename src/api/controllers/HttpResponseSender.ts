...
export class HttpResponseSender {
     ...
     * @throws {Error} If the provided object cannot be converted to the standard body media type.
     */
    public badRequestResponse = <T>(res: Response, object: T): void => {
        this.setUpAndSendResponse(res, object, StatusCodes.BAD_REQUEST);
    }
     ...
     * @throws {Error} If the provided object cannot be converted to the standard body media type.
     */
    public notFoundResponse = <T>(res: Response, object: T): void => {
        this.setUpAndSendResponse(res, object, StatusCodes.NOT_FOUND);
    }
     ...
     * @throws {Error} If the provided object cannot be converted to the standard body media type.
     */
    public internalServerErrorResponse = <T>(res: Response, object: T): void => {
        this.setUpAndSendResponse(res, object, StatusCodes.INTERNAL_SERVER_ERROR);
    }
